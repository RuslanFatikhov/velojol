...
map.on('load', () => {
    ...
    fetch('bikePathsData-kz.json')
        .then(response => response.json())
        .then(data => {
            data.forEach(bikePath => {
                const safetyLevels = {
                    5: { color: '#64C750', text: 'Керемет' },
                    4: { color: '#FFBD3F', text: 'Жарайды' },
                    3: { color: '#E55D47', text: 'Жаман' },
                    2: { color: '#772613', text: 'Өте жаман' },
                    1: { color: '#121212', text: 'Өте қауіпті' }
                };
